...
mig_external kern_return_t __MIG_check__Request__mach_exception_raise_identity_protected_t(__attribute__((__unused__)) __Request__mach_exception_raise_identity_protected_t *In0P)
{
...
#if	__MigTypeCheck
	if (In0P->task_id_token_t.type != MACH_MSG_PORT_DESCRIPTOR ||
	    In0P->task_id_token_t.disposition != 17)
		return MIG_TYPE_ERROR;
#endif	/* __MigTypeCheck */

#if defined(__NDR_convert__int_rep__Request__mach_exception_raise_identity_protected_t__codeCnt__defined)
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request__mach_exception_raise_identity_protected_t__codeCnt(&In0P->codeCnt, In0P->NDR.int_rep);
...
#if	defined(__MIG_check__Request__mach_exception_raise_identity_protected_t__defined)
	check_result = __MIG_check__Request__mach_exception_raise_identity_protected_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_exception_raise_identity_protected_t__defined) */
...
mig_external kern_return_t __MIG_check__Request__mach_exception_raise_state_identity_protected_t(__attribute__((__unused__)) __Request__mach_exception_raise_state_identity_protected_t *In0P, __attribute__((__unused__)) __Request__mach_exception_raise_state_identity_protected_t **In1PP)
{
	...
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request__mach_exception_raise_state_identity_protected_t__codeCnt(&In0P->codeCnt, In0P->NDR.int_rep);
	...
	*In1PP = In1P = (__Request *) ((pointer_t) In0P + msgh_size_delta - 16);
	...
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request__mach_exception_raise_state_identity_protected_t__old_stateCnt(&In1P->old_stateCnt, In1P->NDR.int_rep);
...
#if	defined(__MIG_check__Request__mach_exception_raise_state_identity_protected_t__defined)
	check_result = __MIG_check__Request__mach_exception_raise_state_identity_protected_t((__Request *)In0P, (__Request **)&In1P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request__mach_exception_raise_state_identity_protected_t__defined) */
...
const struct catch_mach_exc_subsystem catch_mach_exc_subsystem = {
	...
	(vm_address_t)0,
	{
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_exception_raise_identity_protected, 7, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_exception_raise_identity_protected_t)},
		{0, 0, 0, 0, 0, 0},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xmach_exception_raise_state_identity_protected, 12, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__mach_exception_raise_state_identity_protected_t)},
	}
};
