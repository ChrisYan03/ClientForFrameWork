...
extern
#endif
kern_return_t __MIG_check__Request__mach_exception_raise_identity_protected_t(__Request__mach_exception_raise_identity_protected_t *In0P);
#ifdef mig_external
mig_external
#else
extern
#endif
kern_return_t __MIG_check__Request__mach_exception_raise_state_identity_protected_t(__Request__mach_exception_raise_state_identity_protected_t *In0P, __Request__mach_exception_raise_state_identity_protected_t **In1PP);
