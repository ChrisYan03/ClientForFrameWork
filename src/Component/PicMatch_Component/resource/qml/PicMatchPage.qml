    ...
    RowLayout {
        ...
        PlayerHostItem {
            ...
            onWidgetReady: {
                if (picMatchViewModel) {
                    // 获取窗口ID并注册
                    var windowId = playerHost.hostWindow
                    if (windowId) {
                        picMatchViewModel.registerWindow(windowId)
                    }
                }
            }
        }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                StackLayout {
                    ...
                    // 页面0：人脸显示
                    FaceShowPanel {
                        faceList: picMatchViewModel.faceList
                        themeColors: appController ? appController.themeColors : {}
